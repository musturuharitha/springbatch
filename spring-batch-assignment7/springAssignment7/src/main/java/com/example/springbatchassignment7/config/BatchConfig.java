...
import com.example.springbatchassignment7.batch.Writer;
...
//	        flatFileItemReader.setResource(new FileSystemResource("src/main/resources/student"));
	...
	public LineMapper<Student> lineMapper(){
		...
		DelimitedLineTokenizer lineTokenizer=new DelimitedLineTokenizer();
	        ...
	        lineTokenizer.setNames("id","name","marks","grade");
	...
	public Writer itemWriter() {
     ...
     fieldExtractor.setNames(new String[] { "id", "name", "marks","grade" });
